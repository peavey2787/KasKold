...
/**
 * Calculate total balance from UTXOs using precise conversion
 * @param {Array} utxos - Array of UTXO objects with 'amount' field
 * @returns {Object} Balance information
 */
export function calculateTotalBalanceFromUTXOs(utxos) {
    ...
    try {
        ...
        console.error('Error calculating total balance from UTXOs:', error);
        return {
            totalBalanceSompi: 0n,
            totalBalanceKas: '0.00000000',
            utxoCount: 0,
